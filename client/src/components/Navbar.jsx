  ...
  return (
    ...
    ${location.pathname === "/" && "bg-light"}`}> 
        ...
        rounded-full max-w-56'>
            <input type="text" className="py-1.5 w-full bg-transparent outline-0
        ...
        <div className='flex max-sm:flex-col items-start sm:items-center gap-6'>
            ...
            <button onClick={() => setShowLogin(true)} className='cursor-pointer px-8 py-1.5 bg-primary hover:bg-primary-dull
            transiton-all text-white rounded-lg'>Login</button>
        </div>
        </div>
